...
export const projects = [
  {
    id: 0,
    title: "Manuscript",
    subtitle: "platform for writers",
    description:
      "This platform is a digital workspace designed for writers to plan, manage, and track their writing projects. It allows users to create structured manuscripts with chapters and scenes, set writing goals, organize notes and references, and monitor progress over time. The interface supports flexible project management while keeping everything in one place — from story outlines to daily writing streaks.",
    technologies: [
      "React",
      "Next.js",
      "TypeScript",
